...
3.1. Creating a Map
Part 1: Define the input for Alaska Region Map:
```{r, eval=FALSE}
varToPlot=AlaskaMap$Recreation_Visits
```

3.1. Creating a Map
Part 1.1: Get colors and intervals for Alaska Region Map:
```{r}
...
plot(IntermounMap, col = colorPallette,border='grey',main=title)
legend('topright', legend = names(attr(colorPallette, "table")), 
       fill = attr(colorPallette, "palette"), cex = shrinkLegend, 
       bty = "n",
       title=legendText)
...
3.1. Creating a Map
Part 3: Define the input for Midwest Region Map
```{r, eval=FALSE}
varToPlot=midWMap$Recreation_Visits
```

3.1. Creating a Map
Part 3.1: Get colors and intervals for Midwest Region Map
```{r, eval=FALSE}
library(RColorBrewer)
library(classInt)
numberOfClasses = 3
...
plot(midWMap, col = colorPallette,border='grey',main=title)
legend('topright', legend = names(attr(colorPallette, "table")), 
       fill = attr(colorPallette, "palette"), cex = shrinkLegend, 
       bty = "n",
       title=legendText)
...
3.1. Creating a Map
Part 4: Define the input for Pacific West Region Map
```{r, eval=FALSE}
varToPlot=pacWestMap$Recreation_Visits
```

3.1. Creating a Map
Part 4.1: Get colors and intervals for Pacific West Region Map
```{r, eval=FALSE}
library(RColorBrewer)
library(classInt)
numberOfClasses = 3
...
plot(pacWestMap, col = colorPallette,border='grey',main=title)
legend('topright', legend = names(attr(colorPallette, "table")), 
       fill = attr(colorPallette, "palette"), cex = shrinkLegend, 
       bty = "n",
       title=legendText)
